...
1. Modify or add environment variables to configure the running application. Environment variables can be configured by modifying the `env` node in the following files:
    - [app/client-remix.bicep](./infra/app/client-remix.bicep)
...
- [app/client-remix.bicep](./infra/app/client-remix.bicep) - Azure Container Apps resources to host the 'client-remix' service.
